...
object EnglishStrings {
    val strings = mapOf(
        ...
        "GENDER_AVATAR" to "Gender & Avatar",
        ...
        "ENTER_NAME" to "Enter character name",
        "ENTER_RELATIONSHIP" to "Enter relationship",
        "RELATIONSHIP_REQUIRED" to "Relationship *",
        "RELATIONSHIP_PLACEHOLDER" to "e.g., Friend, Teacher, Partner",
        "OR_SELECT" to "Or select:",
...
object FrenchStrings {
    val strings = mapOf(
        ...
        "ENTER_NAME" to "Entrez le nom du personnage",
        "ENTER_RELATIONSHIP" to "Entrez la relation",
        "RELATIONSHIP_REQUIRED" to "Relation *",
        "RELATIONSHIP_PLACEHOLDER" to "ex: Ami, Enseignant, Partenaire",
        "OR_SELECT" to "Ou sélectionner:",
...
object ChineseStrings {
    val strings = mapOf(
        ...
        "ENTER_NAME" to "输入角色名称",
        "ENTER_RELATIONSHIP" to "输入关系",
